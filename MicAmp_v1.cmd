Netlist(Freeze)
Netlist(Clear)
Netlist(Add,unnamed_net10,R11-1)
Netlist(Add,unnamed_net10,S1-3)
Netlist(Add,unnamed_net9,R13-1)
Netlist(Add,unnamed_net9,S1-2)
Netlist(Add,unnamed_net8,U2-6)
Netlist(Add,unnamed_net8,U2-2)
...
Netlist(Add,Chassis_GND,CONN5-1)
...
Netlist(Add,unnamed_net7,R10-2)
Netlist(Add,unnamed_net7,CONN3-1)
Netlist(Add,unnamed_net6,C31-1)
Netlist(Add,unnamed_net6,U1-2)
Netlist(Add,unnamed_net6,R11-2)
Netlist(Add,unnamed_net6,R13-2)
Netlist(Add,unnamed_net6,R31-1)
Netlist(Add,unnamed_net5,C31-2)
Netlist(Add,unnamed_net5,U1-6)
Netlist(Add,unnamed_net5,U2-3)
Netlist(Add,unnamed_net5,R31-2)
Netlist(Add,V_BIAS,CONN6-1)
Netlist(Add,V_BIAS,C7-1)
Netlist(Add,V_BIAS,R24-1)
...
Netlist(Add,GND,CONN9-2)
Netlist(Add,GND,CONN9-1)
Netlist(Add,GND,CONN8-2)
Netlist(Add,GND,CONN8-1)
...
Netlist(Add,GND,R23-1)
Netlist(Add,unnamed_net4,CONN7-1)
...
Netlist(Add,unnamed_net2,R23-2)
...
Netlist(Add,P15V,C12-2)
Netlist(Add,P15V,C5-1)
...
Netlist(Thaw)
ElementList(Start)
ElementList(Need,"CONN9","connector(2, 1, spacing=100.00mil, pin_drill=50.00mil, silkmark=external)","unknown")
ElementSetAttr("CONN9","device","CONNECTOR_2")
ElementSetAttr("CONN9","manufacturer","unknown")
ElementSetAttr("CONN9","manufacturer_part_number","unknown")
ElementSetAttr("CONN9","vendor","unknown")
ElementSetAttr("CONN9","vendor_part_number","unknown")
ChangePinName("CONN9", 1, "1")
ChangePinName("CONN9", 2, "2")
ElementList(Need,"CONN8","connector(2, 1, spacing=100.00mil, pin_drill=50.00mil, silkmark=external)","unknown")
ElementSetAttr("CONN8","device","CONNECTOR_2")
ElementSetAttr("CONN8","manufacturer","unknown")
ElementSetAttr("CONN8","manufacturer_part_number","unknown")
ElementSetAttr("CONN8","vendor","unknown")
ElementSetAttr("CONN8","vendor_part_number","unknown")
ChangePinName("CONN8", 1, "1")
ChangePinName("CONN8", 2, "2")
ElementList(Need,"CONN7","sandals","unknown")
ElementSetAttr("CONN7","device","unknown")
...
ElementList(Need,"CONN6","connector(1, 1, spacing=100.00mil, pin_drill=50.00mil, silkmark=external)","IO")
ElementSetAttr("CONN6","device","none")
ElementSetAttr("CONN6","manufacturer","unknown")
ElementSetAttr("CONN6","manufacturer_part_number","unknown")
ElementSetAttr("CONN6","vendor","unknown")
ElementSetAttr("CONN6","vendor_part_number","unknown")
ChangePinName("CONN6", 1, "I/O")
...
ElementList(Need,"C11","ACY400","1uF")
...
ElementList(Need,"C31","ACY300","39pF")
ElementSetAttr("C31","device","CAPACITOR")
ElementSetAttr("C31","manufacturer","unknown")
ElementSetAttr("C31","manufacturer_part_number","unknown")
ElementSetAttr("C31","vendor","unknown")
ElementSetAttr("C31","vendor_part_number","unknown")
ChangePinName("C31", 2, "2")
ChangePinName("C31", 1, "1")
ElementList(Need,"R13","ACY400","5.49K")
...
ElementList(Need,"R11","ACY400","499")
...
ElementList(Need,"C10","ACY400","1uF")
...
ElementList(Need,"C12","RCY100","0.1uF")
...
ElementList(Need,"CONN5","connector(1, 1, spacing=100.00mil, pin_drill=50.00mil, silkmark=external)","IO")
...
ElementList(Need,"C13","RCY100","0.1uF")
...
ElementList(Need,"R31","ACY400","49.9K")
...
ElementList(Need,"R1","ACY400","220K")
...
ElementList(Need,"C7","RCY100P","100uF")
...
ChangePinName("C7", 2, "-")
ChangePinName("C7", 1, "+")
ElementList(Need,"R24","ACY400","4.7K")
...
ElementList(Need,"C6","RCY100P","100uF")
...
ChangePinName("C6", 2, "-")
ChangePinName("C6", 1, "+")
ElementList(Need,"C5","RCY100","0.1uF")
...
ElementList(Need,"R23","ACY400","562")
...
ElementList(Need,"R22","ACY400","90.9")
...
ElementList(Need,"C1","ACY400","10uF")
